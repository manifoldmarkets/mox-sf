        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="aspect-[3/1] bg-[#123c75] hover:bg-[#0f2f5c] transition-all duration-200 flex items-center justify-center overflow-hidden p-3 rounded-lg"
            >
              <img
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="aspect-[3/1] bg-[#193655] hover:bg-[#142b44] transition-all duration-200 flex items-center justify-center p-3 rounded-lg"
            >
              <img
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="aspect-[3/1] bg-[#071024] hover:bg-[#050b1a] transition-all duration-200 flex items-center justify-center p-3 rounded-lg"
            >
              <img
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="aspect-[3/1] bg-[#00666d] hover:bg-[#005259] transition-all duration-200 flex items-center justify-center p-3 gap-2 rounded-lg"
            >
              <img
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="aspect-[3/1] bg-[#2c97cc] hover:bg-[#2383b3] transition-all duration-200 flex items-center justify-center p-3 gap-2 rounded-lg"
            >
              <img
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="aspect-[3/1] bg-[#5e6f60] hover:bg-[#4d5c4f] transition-all duration-200 flex items-center justify-center p-1 gap-1 rounded-lg"
            >
              <img
                src="https://media.licdn.com/dms/image/v2/D4D0BAQHZqWt1BOeRcQ/company-logo_200_200/company-logo_200_200/0/1719263296894/rootsofprogress_logo?e=2147483647&v=beta&t=ST2NF9TmGYBHrprrUCW_W1d_ZLnYFU8UCZlFC9-e9vs"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="aspect-[3/1] bg-[#eaf5f4] hover:bg-[#d5e8e6] transition-all duration-200 flex items-center justify-center p-3 gap-2 rounded-lg"
            >
              <img
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="aspect-[3/1] bg-[#00104e] hover:bg-[#000c3d] transition-all duration-200 flex items-center justify-center p-3 rounded-lg"
            >
              <img
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="aspect-[3/1] bg-white dark:bg-background-accent-dark hover:bg-slate-100 dark:hover:bg-background-subtle-dark transition-all duration-200 flex items-center justify-center p-3 gap-2 border-2 border-secondary-600 dark:border-primary-600 rounded-lg"
            >
              <img
