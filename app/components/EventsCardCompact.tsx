        ...
        upcomingEvents.map((event) => {
          ...
          return (
            <Link
              key={event.id}
              href="/events"
              className="flex items-center bg-background-surface dark:bg-background-surface-dark hover:bg-secondary-50 dark:hover:bg-background-subtle-dark rounded-lg transition-colors border border-border-light dark:border-secondary-700 overflow-hidden"
            >
