      ...
      <div className="space-y-4">
        <div>
          <p className="text-sm text-text-muted dark:text-text-muted-dark mb-2">
            Your personal, unchanging PIN Code, you can give this to your
            guests, although you still need to be in the building when they are.
          </p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 max-w-md w-full p-6">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              This is mostly for if you regret posting it somewhere or sharing
              it with someone. Your current PIN ({pin}#) will stop working
              immediately, and you'll get a random new one.
            </p>
