    ...
    <div className="min-h-screen bg-slate-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
      ...
      <div className="relative min-h-[60vh] flex items-center justify-center px-4 sm:px-6 py-16 sm:py-24">
        ...
        <div className="relative z-10 max-w-4xl w-full text-center">
          <h1 className="text-4xl sm:text-5xl font-bold text-amber-900 dark:text-amber-400 font-playfair mb-6">
            Office Space at Mox
          </h1>
          <p className="text-xl sm:text-2xl text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-16">
          <div className="bg-orange-50 dark:bg-gray-800 bg-opacity-95 dark:bg-opacity-95 shadow-xl rounded-2xl sm:rounded-3xl overflow-hidden">
            <img
              src="/images/005.jpg"
            ...
            <div className="p-6 sm:p-8">
              <h2 className="text-3xl font-bold text-amber-900 dark:text-amber-400 font-playfair mb-3">
                Private Offices
              </h2>
              ...
              <ul className="space-y-2 mb-6 text-gray-700 dark:text-gray-300">
                <li className="flex items-start gap-2">
                  <span className="text-amber-800 dark:text-amber-400 mt-1">•</span>
              ...
              <div className="bg-white dark:bg-gray-700 rounded-lg p-4 mb-4">
                <p className="text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1">Pricing</p>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-amber-900 dark:text-amber-400 font-playfair mb-6 text-center">
            What Makes Mox Different
          </h2>
        ...
        <section className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="px-8 py-4 bg-amber-800 dark:bg-amber-700 text-white font-semibold hover:bg-amber-900 dark:hover:bg-amber-800 transition-colors rounded-full text-center"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 bg-white dark:bg-gray-700 border-2 border-amber-800 dark:border-amber-700 text-amber-800 dark:text-amber-300 font-semibold hover:bg-amber-50 dark:hover:bg-gray-600 transition-colors rounded-full text-center"
            >
              Schedule a tour
            </a>
          </div>
